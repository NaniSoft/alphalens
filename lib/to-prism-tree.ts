...
/**
 * Flatten a section's page tree into sidebar entries. Separators become group
 * headers (a link-less entry — DocsShell renders it as an anchor without an
 * href, which the site CSS styles as a label); folders carry their index
 * page's URL and nest their children.
 */
